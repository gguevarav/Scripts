...
Dim strDirectory
Dim strFile
strDirectory = "\\10.4.6.98\Compartida\"
'strDirectory = "\\10.4.1.134\inventario\"    'Dirección donde se desea guardar la información
strFile = "inventario.txt"                       'Nombre del archivo donde se guardará la información
...
strOSVersion = objShell.RegRead("HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\ProductName")' Leer el registro para obtener la versión del sistema operativo

strOfficeVersion = "Office " & GetOfficeVersionNumber() ' Lectura de la versión de office a través de una función.
