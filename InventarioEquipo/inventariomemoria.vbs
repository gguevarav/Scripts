...
strMemoria = InputBox("Ingrese la letra de la memoria", "Ingrese la letra de la memoria", "d")
...
Dim strDirectory
Dim strFile
'strDirectory = "\\10.4.1.206\inventario$\InventarioEquipos\"
'strDirectory = "\\10.4.1.134\inventario\"    'Direccion donde se desea guardar la informacion
strDirectory = strMemoria 'Direccion donde se desea guardar la informacion
